/* assets/js/commands.js
   => Hier pflegst du ALLE Sequenzen zentral.
   Tipp: Nutze Template-Literals (`...`) für lange G-Code-Blöcke.
   Achte darauf, dass {slicer_placeholders} in Backticks OK sind.
*/
...
window.SWAP_RULES = [
  ...
  {
    id: "a1m_prepend_ini",
    description: "Prepend _1n1_gC0d3 at top of the very first plate (A1M only)",
    enabled: true,
    order: 5,                      // sehr früh
    action: "prepend",
    scope: "startseq",
    ...
    // dynamischer Payload: aus globaler Variable _1n1_gC0d3
    payloadVar: "_1n1_gC0d3",      // siehe Engine (holt window._1n1_gC0d3)
    wrapWithMarkers: true          // idempotent
  },
